...
using MaintenanceReminder.Properties;
...
namespace MaintenanceReminder
{
    public partial class FormMain : Form
    {
        ...
        public static void ClearCalibrationHistoryData()
        {
            ...
            ClassGv.CalibrationHistoryList.CalibrationCompany.Clear();
            ClassGv.CalibrationHistoryList.NumberOfCertificate.Clear();
        ...
        public static void ClearActiveCalibrationData()
        {
            ...
            ClassGv.ActiveCalibrationList.CalibrationCompany.Clear();
            ClassGv.ActiveCalibrationList.NumberOfCertificate.Clear();
        ...
        public static void ClearNearestAndPassedCalibration()
        {
            ...
            ClassGv.NearestCalibration.CalibrationCompany.Clear();
            ClassGv.NearestCalibration.NumberOfCertificate.Clear();
            ...
            ClassGv.PassedCalibration.CalibrationCompany.Clear();
            ClassGv.PassedCalibration.NumberOfCertificate.Clear();
        ...
        {
            ClearDeviceData();
            ClassTxt.FileCreate(ClassGv.FilePathOfDeviceList);

            string[] temp = ClassTxt.Read(ClassGv.FilePathOfDeviceList).Split(';');
        ...
        public static void GetCalibrationHistoryList()
        {
            ...
            ClassTxt.FileCreate(ClassGv.FilePathOfCalibrationHistoryList);

            string[] temp = ClassTxt.Read(ClassGv.FilePathOfCalibrationHistoryList).Split(';');
            for (int i = 0; i < temp.Length - 1; i = i + 13)
            {
                ...
                ClassGv.CalibrationHistoryList.CalibrationCompany.Add(temp[i + 10]);
                ClassGv.CalibrationHistoryList.NumberOfCertificate.Add(temp[i + 11]);
                ClassGv.CalibrationHistoryList.CalibrationNote.Add(temp[i + 12]);
            }
        }
        ...
        public static void GetActiveCalibrationList()
        {
            ...
            ClassTxt.FileCreate(ClassGv.FilePathOfActiveCalibrationList);

            string[] temp = ClassTxt.Read(ClassGv.FilePathOfActiveCalibrationList).Split(';');
            for (int i = 0; i < temp.Length - 1; i = i + 13)
            {
                ...
                ClassGv.ActiveCalibrationList.CalibrationCompany.Add(temp[i + 10]);
                ClassGv.ActiveCalibrationList.NumberOfCertificate.Add(temp[i + 11]);
                ClassGv.ActiveCalibrationList.CalibrationNote.Add(temp[i + 12]);
            }
        }
        ...
        public static void CalculateNearestAndPassedCalibration()
        {
            ...
            for (int i = 0; i < ClassGv.ActiveCalibrationList.NextCalibrationDate.Count; i++)
            {
                ...
                if (timeSpan < TimeSpan.Zero)
                {
                    ...
                    ClassGv.PassedCalibration.CalibrationCompany.Add(ClassGv.ActiveCalibrationList.CalibrationCompany[i]);
                    ClassGv.PassedCalibration.NumberOfCertificate.Add(ClassGv.ActiveCalibrationList.NumberOfCertificate[i]);
                ...
                else if (timeSpan < remainingTime)
                {
                    ...
                    ClassGv.NearestCalibration.CalibrationCompany.Add(ClassGv.ActiveCalibrationList.CalibrationCompany[i]);
                    ClassGv.NearestCalibration.NumberOfCertificate.Add(ClassGv.ActiveCalibrationList.NumberOfCertificate[i]);
        ...
        {
            tbMail1.Text = Properties.Settings.Default.MailAddress1;
            tbMail2.Text = Properties.Settings.Default.MailAddress2;
        }
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            tlpInfo.Controls.Add(btnNearestCalibrations, 0, 0);
            ...
            tlpInfo.Controls.Add(btnPassedCalibrations, 0, 1);
        ...
        private void sendMail(string body)
        {
            try
            {
                ...
                mailMessage.To.Add(tbMail1.Text);
                mailMessage.To.Add(tbMail2.Text);
                mailMessage.From = new MailAddress("sender@gmail.com", "Lütfi Yıldırım");
                mailMessage.Subject = "Kalibrasyon hatırlatması";
                mailMessage.IsBodyHtml = true;
                mailMessage.Body = body;
                SmtpClient smtpClient = new SmtpClient();
                smtpClient.UseDefaultCredentials = true;
                smtpClient.Credentials = new System.Net.NetworkCredential("sender@gmail.com", "ufpm valy tidy vhbn");
        ...
        private void buttonSendMail_Click(object sender, EventArgs e)
        {
            ...
            string Body =
                "<body>" +
                "<h2>Dikkat! &#128640;</h2>" +
                "<p>Bakımı yaklaşan veya geçen cihazlar aşağıda listelenmiştir.</p>" +
                "</body>";
            string Message = "";
            ...
            {
                MessageBox.Show("Yaklaşan veya geçmiş kalibrasyon olmadığı için mail gönderilmedi");
            }
        }
        ...
        private void tbMail1_Validated(object sender, EventArgs e)
        {
            Properties.Settings.Default.MailAddress1 = tbMail1.Text;
            Properties.Settings.Default.MailAddress2 = tbMail2.Text;
